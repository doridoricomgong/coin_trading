    ...
    try: 
        ...
        if "/USDT" in ticker:
            ...
            if abs(amt_s) == 0:
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'market', 'sell', FirstAmt))
                #해당 코인 가격을 가져온다.
                coin_price = myBybit.GetCoinNowPrice(bybitX, Target_Coin_Ticker)
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'buy', FirstAmt, target_price,{'reduce_only': True,'close_on_trigger':True}))
                ...
                while TotalWater_Amt + Water_amt < Max_Water_Amt - Adjust_Max_Amt: ######여기서 최대 맥스수량을 보정해 줍니다#####
                    ...
                    print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'sell', Water_amt, water_price))
                ...
                if abs(amt_s) > 0:
                    ...
                    if Is_Water_Remain == False:
                        ...
                        print(bybitX.create_order(Target_Coin_Ticker, 'market', 'buy', Cut_Amt, None,{'reduce_only': True,'close_on_trigger':True}))
                        ...
                        print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'buy', abs(amt_s), target_price,{'reduce_only': True,'close_on_trigger':True}))
            ...
            if abs(amt_b) == 0:
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'market', 'buy', FirstAmt))
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'sell', FirstAmt, target_price,{'reduce_only': True,'close_on_trigger':True}))
                ...
                while TotalWater_Amt + Water_amt < Max_Water_Amt - Adjust_Max_Amt: ######여기서 최대 맥스수량을 보정해 줍니다#####
                    ...
                    print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'buy', Water_amt, water_price))
                ...
                if abs(amt_b) > 0:
                    ...
                    if Is_Water_Remain == False:
                        ...
                        print(bybitX.create_order(Target_Coin_Ticker, 'market', 'sell', Cut_Amt, None,{'reduce_only': True,'close_on_trigger':True}))
                        ...
                        print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'sell', abs(amt_b), target_price,{'reduce_only': True,'close_on_trigger':True}))
                        ...
                        while TotalWater_Amt + Water_amt < Max_Water_Amt - Adjust_Max_Amt: #여기서 보정을 합니다
                            ...
                            #print(bybitX.create_limit_buy_order(Target_Coin_Ticker, Water_amt, water_price))
                            print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'buy', Water_amt, water_price,{'reduce_only': True,'close_on_trigger':True}))

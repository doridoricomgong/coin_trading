    ...
    if amt < 0:
        ...
        if ma5 < ma20 and ma5_before3 > ma5_before2 and ma5_before2 < ma5:
            ...
            if revenue_rate >= target_revenue_rate:
                ...
                print(binanceX.create_order(Target_Coin_Ticker, 'limit', 'buy', abs_amt + first_amount, coin_price))
        ...
        if revenue_rate <= danger_rate and buy_percent >= 90.0:
            ...
            print(binanceX.create_order(Target_Coin_Ticker, 'limit', 'buy', abs_amt / 2.0, coin_price))

    ...
    try: 
        ...
        if "/USDT" in ticker:
            ...
            if abs(amt_b) == 0:
                ...
                data = bybitX.create_order(Target_Coin_Ticker, 'market', 'buy', test_amt, None)
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'sell', test_amt, target_price, {'reduce_only': True,'close_on_trigger':True}))
            ...
            if abs(amt_s) == 0:
                ...
                data = bybitX.create_order(Target_Coin_Ticker, 'market', 'sell', test_amt, None)
                ...
                print(bybitX.create_order(Target_Coin_Ticker, 'limit', 'buy', test_amt, target_price, {'reduce_only': True,'close_on_trigger':True}))
